  ...
  <div class="job-list-page">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="行业分类" prop="subCategoryId">
              <el-select v-model="form.subCategoryId" placeholder="请选择行业分类" style="width: 100%">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="面试官" prop="interviewerId">
              <el-select v-model="form.interviewerId" placeholder="请选择面试官" style="width: 100%">
                <el-option
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="学历要求" prop="educationReq">
              <el-select v-model="form.educationReq" placeholder="请选择学历要求" style="width: 100%">
    ...
    <el-dialog v-model="viewDialogVisible" title="职位详情" width="60%">
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="职位名称" :span="1">{{ currentJob?.title }}</el-descriptions-item>
        <el-descriptions-item label="公司名称" :span="1">
          {{ currentJob?.company?.name }}
        </el-descriptions-item>
        <el-descriptions-item label="工作城市" :span="1">{{ currentJob?.city }}</el-descriptions-item>
